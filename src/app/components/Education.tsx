  ...
  return (
    <>
      <section className="py-28 px-6 sm:px-12 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative border-l-2 border-stone-100 pl-8 ml-4 sm:ml-0 md:pl-0 md:border-none space-y-12">
            ...
            <div className="hidden md:block absolute left-1/2 top-3 bottom-3 w-0.5 -translate-x-1/2 rounded-full bg-gradient-to-b from-transparent via-[#c8afe8] to-transparent shadow-[0_0_18px_rgba(185,157,222,0.45)]" />
            ...
            >
              ...
              <motion.div
                ...
                className="bg-stone-50 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow"
              >
      ...
      <div className="relative w-full py-10 bg-white">
        <div className="mx-auto h-px w-[85%] rounded-full bg-gradient-to-r from-transparent via-[#c8afe8] to-transparent opacity-80 shadow-[0_0_20px_rgba(185,157,222,0.35)]" />
      </div>
    </>
  );
}
