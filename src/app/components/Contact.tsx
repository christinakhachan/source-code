  ...
  return (
    <section className="py-24 px-6 sm:px-12 bg-stone-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        >
          I'm always open to discussing psychology, new opportunities, and ways we can collaborate to support mental well-being.
        </motion.p>
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto mb-16">
          ...
          >
            ...
            <p className="text-stone-500 font-light text-sm">Christina.khachan1@hotmail.com</p>
          </motion.a>
          ...
          >
            ...
            <p className="text-stone-500 font-light text-sm">Beirut, Lebanon</p>
          </motion.div>
