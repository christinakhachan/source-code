...
const projects = [
  ...
  {
    title: "PSL 211 Course Reflection",
  ...
  {
    title: "Reflection Assignment: Ch 6 & 7",
  ...
  {
    title: "PSL 201: Chapter 9 Reflection",
...
export default function Projects() {
  return (
    <section id="projects" className="py-24 px-6 sm:px-12 bg-stone-50 scroll-mt-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h3 className="text-teal-700 font-medium tracking-wide uppercase text-sm mb-4">Academic & Research Work</h3>
          <h2 className="text-4xl sm:text-5xl font-['Playfair_Display',serif] text-stone-900 mb-4">My Projects</h2>
